                ...
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <CardTitle className="text-sm font-semibold">
                      1g<span className="relative inline-block"><span className="absolute inset-0 flex items-center justify-center pointer-events-none select-none"><span className="w-[0.45em] h-[0.45em] bg-[#A6FF00] rounded-full translate-y-[0.1em]" /></span><span className="relative z-10">o</span></span>li Assistant
                    </CardTitle>
